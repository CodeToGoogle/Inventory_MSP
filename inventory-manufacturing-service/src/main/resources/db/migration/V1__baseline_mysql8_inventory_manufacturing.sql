-- V1__baseline_mysql8_inventory_manufacturing.sql
...
CREATE TABLE ManufacturingWorkCenters (
...
CREATE TABLE ManufacturingOperations (
...
CREATE TABLE ManufacturingOrderLines (
