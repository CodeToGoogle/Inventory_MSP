...
CREATE TABLE IF NOT EXISTS InventoryDeliveryMethods (
...
CREATE TABLE IF NOT EXISTS InventoryTransactionsLine (
    ...
    FOREIGN KEY (BatchID) REFERENCES BatchSerialNumbers(BatchID),
